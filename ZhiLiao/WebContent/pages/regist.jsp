...
<script type="text/javascript">  
	function checkForm(){
		...
		document.forms[0].action="user?action=userAdd";
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet"> 
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" ><a href="javascript:reloadCode();"><img src="<%= request.getContextPath()%>/servlet/ImageServlet" alt="验证码" id="imagecode" />
											看不清,换一张
											</a>
										</span>
									</td>
							...
							<tr>
								...
								<td>
									<input type="submit" onClick="javascript:checkForm()" id="submit" class="submit" value="同意以下协议并注册">
								</td>
							</tr>
							<tr>
								<th>&nbsp;
